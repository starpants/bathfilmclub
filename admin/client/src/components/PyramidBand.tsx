...
interface Props {
  title: string;
  color: string;
  /** Optional controls for this band, rendered under the heading and excluded
   *  from the film count below — children must stay films-only. */
  toolbar?: ReactNode;
  children: ReactNode;
}
...
export function PyramidBand({ title, color, toolbar, children }: Props) {
